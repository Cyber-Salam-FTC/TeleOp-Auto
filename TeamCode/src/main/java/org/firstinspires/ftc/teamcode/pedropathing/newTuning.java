...
//        private boolean initialKick = false;
//
//        @Override
//        public void init() {}
//
...
//
//        /**
//         * This boolean performs the oscillatory test to find the kP and kD values using the Ziegler-Nichols method
//         */
//        private boolean runOscillation(int axis, double t) {
//            double error;
//            if (axis == 2) {
//                double h = follower.getPose().getHeading();
//                error = ((h + Math.PI) % (2 * Math.PI)) - Math.PI;
//            } else {
//                error = (axis == 0) ? follower.getPose().getX() : follower.getPose().getY();
//            }
//
//            if (axis == 2 && !initialKick && t < 0.3) {
//                follower.setTeleOpDrive(0, 0, 0.4, false);
//                previousError = error;
//                return false;
//            }
//
//            if (!isOscillating) {
//                highKp += 0.0005;
//                if (Math.abs(error) > (axis == 2 ? 0.1 : 5.0)) isOscillating = true;
...
//     */
//    static class AutoLocalizationTest extends OpMode {
//
//        Boolean xCorrect;
//        Boolean yCorrect;
