    ...
    import static org.firstinspires.ftc.teamcode.pedropathing.newTuning.changes;
    import static org.firstinspires.ftc.teamcode.pedropathing.newTuning.drawCurrent;
    import static org.firstinspires.ftc.teamcode.pedropathing.newTuning.drawCurrentAndHistory;
    import static org.firstinspires.ftc.teamcode.pedropathing.newTuning.follower;
    import static org.firstinspires.ftc.teamcode.pedropathing.newTuning.stopRobot;
    import static org.firstinspires.ftc.teamcode.pedropathing.newTuning.telemetryM;
    import static org.firstinspires.ftc.teamcode.pedropathing.newTuning.globalForwardVelocity;
    import static org.firstinspires.ftc.teamcode.pedropathing.newTuning.globalLateralVelocity;
    import static org.firstinspires.ftc.teamcode.pedropathing.newTuning.globalForwardZeroPower;
    import static org.firstinspires.ftc.teamcode.pedropathing.newTuning.globalLateralZeroPower;
    ...
    public class newTuning extends SelectableOpMode {
            ...
            public static double globalForwardVelocity;
            public static double globalLateralVelocity;
            public static double globalForwardZeroPower;
            public static double globalLateralZeroPower;
    ...
    class AutoPIDFTuner extends OpMode {

        newTuning.TUNING_TYPE step = newTuning.TUNING_TYPE.DRIVE;
            ...
            switch (step) {
                case DRIVE:
                    ...
                    if (runDriveTuner(currentTime)) {
                        nextStep(newTuning.TUNING_TYPE.TRANSLATIONAL);
                    }
                    break;
                case TRANSLATIONAL:
                    //                Translational tuner
                    if (runOscillation(0, currentTime)) {
                        nextStep(newTuning.TUNING_TYPE.LATERAL);
                    }
                    break;
                case LATERAL:
                    //                Lateral tuner
                    if (runOscillation(1, currentTime)) {
                        nextStep(newTuning.TUNING_TYPE.HEADING);
                    }
                    break;
                case HEADING:
                    //                Heading tuner
                    if (runOscillation(2, currentTime)) {
                        nextStep(newTuning.TUNING_TYPE.CENTRIPETAL);
                    }
                    break;
                case CENTRIPETAL:
                    //                Centripetal tuner
                    if (runCentripetal(currentTime)) {
                        nextStep(newTuning.TUNING_TYPE.COMPLETED);
                    }
                    break;
                case COMPLETED:
                    printResults();
        ...
        private void nextStep(newTuning.TUNING_TYPE next) {
            follower.setTeleOpDrive(0, 0, 0, false);
            step = next;
    ...
    class AutoVelocityTuner extends OpMode {

        newTuning.VELOCITY_TUNING_STEP velocityStep = newTuning.VELOCITY_TUNING_STEP.FORWARD;
        ...
        public void loop() {
            ...
            switch(velocityStep) {
                case FORWARD:
                    forwardTuner();
                    nextStep(newTuning.VELOCITY_TUNING_STEP.LATERAL);
                    break;
                case LATERAL:
                    lateralTuner();
                    nextStep(newTuning.VELOCITY_TUNING_STEP.FORWARD_ZERO_POWER);
                    break;
                case FORWARD_ZERO_POWER:
                    forwardZeroPowerTuner();
                    nextStep(newTuning.VELOCITY_TUNING_STEP.LATERAL_ZERO_POWER);
                    break;
                case LATERAL_ZERO_POWER:
                    lateralZeroPowerTuner();
                    nextStep(newTuning.VELOCITY_TUNING_STEP.COMPLETED);
                    break;
                default:
                    printResults();
            }
        ...
        public void nextStep(newTuning.VELOCITY_TUNING_STEP next) {
            velocityStep = next;
        }
    ...
    class ForwardZeroPower extends OpMode {
     ...
     * @version 1.1, 2/5/2026
     */
    class LateralZeroPower extends OpMode {
        private final ArrayList<Double> accelerations = new ArrayList<>();
        double VELOCITY = 30;
        private double previousVelocity;
        private long previousTimeNano;
