...
public class LocalizationTest extends OpMode {
    ...
    public void loop() {
        ...
        telemetryA.addData("leftFront", leftFront.getCurrentPosition());
        telemetryA.addData("leftRear", leftRear.getCurrentPosition());
        telemetryA.addData("rightFront", rightFront.getCurrentPosition());
        telemetryA.addData("rightRear", rightRear.getCurrentPosition());
