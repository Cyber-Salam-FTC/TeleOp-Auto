...
@Autonomous(name = "Cyber Salam Auto Far Red Stilgard")
public class FarZoneAutoRed extends LinearOpMode {
    ...
    private final Pose SHOOT_POS = new Pose(80, 23, Math.toRadians(65));
...
//    private final Pose COLLECT_POS_9 = new Pose(114, 48, Math.toRadians(0));
    ...
    private final Pose COLLECT_POS = new Pose(123, 23, Math.toRadians(-10));
    private final Pose PRECOLLECT = new Pose(100, 23, Math.toRadians(0));
